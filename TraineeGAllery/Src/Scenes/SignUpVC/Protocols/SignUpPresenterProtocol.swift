...
protocol SignUpPresenterProtocol {
    ...
    /// При нажатии на конпку SignUp идет проверка на заполненность всех полей и их корректность. В случае успеха -> отправка запроса на регистрацию нового пользователя, в случае ошибки -> показ соответсвующего  уведомления
